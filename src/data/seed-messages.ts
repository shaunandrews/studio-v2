...
export const seedMessages: Message[] = [
  ...
  // ═══════════════════════════════════════════
  { id: 'ba1-1', taskId: 'blog-assistant-1', role: 'user', content: 'I want to change the hero section on my homepage to have a gradient background and bigger text.', timestamp: '2026-02-12T10:00:00Z' },
  { id: 'ba1-2', taskId: 'blog-assistant-1', role: 'agent', agentId: 'wpcom', content: "I'll update your hero with a gradient and bump the heading size. One moment.", timestamp: '2026-02-12T10:00:30Z' },
  {
    id: 'ba1-3', taskId: 'blog-assistant-1', role: 'agent', agentId: 'wpcom',
  ...
  { id: 'ba1-4', taskId: 'blog-assistant-1', role: 'user', content: "Love the gradient! But can you make the text white so it's easier to read?", timestamp: '2026-02-12T10:02:00Z' },
  {
    id: 'ba1-5', taskId: 'blog-assistant-1', role: 'agent', agentId: 'wpcom',
  ...
  // ═══════════════════════════════════════════
  { id: 'bc1-1', taskId: 'blog-code-1', role: 'user', content: "I need a custom 'project showcase' block that displays a grid of portfolio items with images and descriptions.", timestamp: '2026-02-11T14:00:00Z' },
  { id: 'bc1-2', taskId: 'blog-code-1', role: 'agent', agentId: 'wpcom', content: "I'll scaffold a custom block called `project-showcase` — `block.json` registration, `InnerBlocks` for flexible card content, and a responsive CSS Grid layout. Let me generate the files.", timestamp: '2026-02-11T14:00:30Z' },
  {
    id: 'bc1-3', taskId: 'blog-code-1', role: 'agent', agentId: 'wpcom',
  ...
  // ═══════════════════════════════════════════
  { id: 'co-1', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "Hi! I'm Kit, your AI assistant.", timestamp: '2026-02-24T10:00:00Z' },
  { id: 'co-2', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "I can design and build just about anything — stores, blogs, portfolios, apps. Just describe what you want and I'll make it happen.", timestamp: '2026-02-24T10:00:04Z' },
  { id: 'co-3', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "So, what are we making?", timestamp: '2026-02-24T10:00:06Z' },
  { id: 'co-4', taskId: 'cafe-onboarding', role: 'user', content: "Restaurant", timestamp: '2026-02-24T10:00:18Z' },
  { id: 'co-5', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "Nice — what's the restaurant called?", timestamp: '2026-02-24T10:00:22Z' },
  { id: 'co-6', taskId: 'cafe-onboarding', role: 'user', content: "Downstreet Café", timestamp: '2026-02-24T10:00:38Z' },
  { id: 'co-7', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "Describe it in a sentence. What kind of food, what's the vibe?", timestamp: '2026-02-24T10:00:42Z' },
  { id: 'co-8', taskId: 'cafe-onboarding', role: 'user', content: "A warm neighborhood café in Portland, Maine. Specialty coffee, fresh pastries, and a community hub — been open since 2018.", timestamp: '2026-02-24T10:01:51Z' },
  { id: 'co-9', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "How do you want the site to look and feel? Any vibe, mood, or style you have in mind?", timestamp: '2026-02-24T10:01:56Z' },
  { id: 'co-10', taskId: 'cafe-onboarding', role: 'user', content: "Warm and editorial, like a well-designed indie coffee shop zine. Serif headings, earthy tones, nothing flashy.", timestamp: '2026-02-24T10:02:44Z' },
  { id: 'co-11', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "Are there any sites you really like, or want to use as inspiration?", timestamp: '2026-02-24T10:02:49Z' },
  { id: 'co-12', taskId: 'cafe-onboarding', role: 'user', content: "bluebottlecoffee.com", timestamp: '2026-02-24T10:03:12Z' },
  { id: 'co-13', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "Let me design **Downstreet Café** for you. I'll create a few design directions to choose from.", timestamp: '2026-02-24T10:03:18Z' },
  { id: 'co-14', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "Crafting design briefs…", timestamp: '2026-02-24T10:03:20Z' },
  { id: 'co-15', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "Here are 3 directions for **Downstreet Café**. Pick the one that feels right:", timestamp: '2026-02-24T10:04:48Z' },
  { id: 'co-16', taskId: 'cafe-onboarding', role: 'user', content: "Warm Editorial", timestamp: '2026-02-24T10:06:02Z' },
  { id: 'co-17', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "**Warm Editorial** — great choice. Inviting editorial warmth with serif headings and a muted earthy palette. Playfair Display + Source Sans Pro. Building it now.", timestamp: '2026-02-24T10:06:08Z' },
  {
    id: 'co-18', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom',
    content: "",
    toolCalls: [
  ...
  { id: 'co-19', taskId: 'cafe-onboarding', role: 'agent', agentId: 'wpcom', content: "**Downstreet Café** is ready! 3 pages, 11 sections. Take a look and let me know if you want to tweak anything.", timestamp: '2026-02-24T10:10:45Z' },

  // ═══════════════════════════════════════════
  // Downstreet Café — homepage hero tweak
  // ═══════════════════════════════════════════
  { id: 'ch-1', taskId: 'cafe-hero-tweak', role: 'user', content: "The hero tagline says \"Coffee crafted with intention\" which is fine, but I want to add our actual hours underneath it. Mon–Fri 7am–5pm, Weekends 8am–6pm.", timestamp: '2026-02-25T09:00:00Z' },
  { id: 'ch-2', taskId: 'cafe-hero-tweak', role: 'agent', agentId: 'wpcom', content: "I'll add the hours below the tagline — smaller text, slightly muted so they don't compete with the headline. Also, want me to change the headline? You mentioned it feels a bit pretentious.", timestamp: '2026-02-25T09:00:06Z' },
  { id: 'ch-3', taskId: 'cafe-hero-tweak', role: 'user', content: "Yeah, change it to \"Your neighborhood coffee shop\" — much more us.", timestamp: '2026-02-25T09:00:28Z' },
  {
    id: 'ch-4', taskId: 'cafe-hero-tweak', role: 'agent', agentId: 'wpcom',
  ...
  // ═══════════════════════════════════════════
  { id: 'cp-1', taskId: 'cafe-photos', role: 'user', content: "The menu page still has placeholder images. I've got real photos now — can you swap them in? I'll upload them to the media library.", timestamp: '2026-02-26T14:00:00Z' },
  { id: 'cp-2', taskId: 'cafe-photos', role: 'agent', agentId: 'wpcom', content: "Go for it — upload them and I'll place them. Are these for specific menu sections, or more general food photography?", timestamp: '2026-02-26T14:00:05Z' },
  { id: 'cp-3', taskId: 'cafe-photos', role: 'user', content: "Both. Hero shots for each of the three menu sections (coffee, pastries, lunch) plus individual item photos for the featured items on the homepage.", timestamp: '2026-02-26T14:00:42Z' },
  {
    id: 'cp-4', taskId: 'cafe-photos', role: 'agent', agentId: 'wpcom',
  ...
  { id: 'cp-5', taskId: 'cafe-photos', role: 'user', content: "Looks great. The lavender latte photo is a little dark though — can you bump the brightness?", timestamp: '2026-02-26T14:03:05Z' },
  {
    id: 'cp-6', taskId: 'cafe-photos', role: 'agent', agentId: 'wpcom',
  ...
  // ═══════════════════════════════════════════
  { id: 'cr-1', taskId: 'cafe-reservations', role: 'user', content: "We want to start taking table reservations online. What's the best way to do that?", timestamp: '2026-02-27T11:00:00Z' },
  { id: 'cr-2', taskId: 'cafe-reservations', role: 'agent', agentId: 'wpcom', content: "For a café your size, I'd go with **Simply Schedule Appointments**. It's lightweight, handles time slots well, and sends email confirmations automatically. I can set up slots matching your hours with 30-minute blocks and a max party size. Want me to install it?", timestamp: '2026-02-27T11:00:08Z' },
  { id: 'cr-3', taskId: 'cafe-reservations', role: 'user', content: "Yeah, do it. Max 4 people per reservation, and block off the last hour of each day for walk-ins only.", timestamp: '2026-02-27T11:00:34Z' },
  {
    id: 'cr-4', taskId: 'cafe-reservations', role: 'agent', agentId: 'wpcom',
  ...
  { id: 'cr-5', taskId: 'cafe-reservations', role: 'user', content: "Can we also add a note field so people can mention allergies or special requests?", timestamp: '2026-02-27T11:04:22Z' },
  {
    id: 'cr-6', taskId: 'cafe-reservations', role: 'agent', agentId: 'wpcom',
  ...
  // ═══════════════════════════════════════════
  { id: 'cs-1', taskId: 'cafe-seo', role: 'user', content: 'I want us to show up when people search "coffee shop Portland Maine." And I need some kind of analytics to see how many people visit the site.', timestamp: '2026-02-28T10:00:00Z' },
  { id: 'cs-2', taskId: 'cafe-seo', role: 'agent', agentId: 'wpcom', content: "Jetpack handles both. **SEO tools** for meta titles, descriptions, and sitemaps. **Jetpack Stats** for visitor analytics right in your dashboard — no Google account needed. I'll also add structured data so Google shows your address and hours in search results.", timestamp: '2026-02-28T10:00:07Z' },
  { id: 'cs-3', taskId: 'cafe-seo', role: 'user', content: "Yep, go ahead.", timestamp: '2026-02-28T10:00:19Z' },
  {
    id: 'cs-4', taskId: 'cafe-seo', role: 'agent', agentId: 'wpcom',
  ...
  { id: 'cs-5', taskId: 'cafe-seo', role: 'user', content: "Should I also set up a Google Business Profile?", timestamp: '2026-02-28T10:04:10Z' },
  { id: 'cs-6', taskId: 'cafe-seo', role: 'agent', agentId: 'wpcom', content: "Absolutely — that's the single biggest thing for local search. Claim your listing at business.google.com, add your hours, photos, and menu link. The schema markup I just added will sync with it so Google shows rich results. I can't create the listing for you (Google requires account verification), but everything on the WordPress side is ready.", timestamp: '2026-02-28T10:04:17Z' },

  // ═══════════════════════════════════════════
  // Downstreet Café — events page
  // ═══════════════════════════════════════════
  { id: 'ce-1', taskId: 'cafe-events', role: 'user', content: "I want a dedicated Events page. We do open mic nights, art shows, and coffee cupping workshops.", timestamp: '2026-03-03T13:00:00Z' },
  { id: 'ce-2', taskId: 'cafe-events', role: 'agent', agentId: 'wpcom', content: "The homepage community section can tease upcoming events, but the full listing deserves its own page. Should I keep the homepage section as a \"what's next\" preview linking to the full Events page?", timestamp: '2026-03-03T13:00:06Z' },
  { id: 'ce-3', taskId: 'cafe-events', role: 'user', content: "Keep it — just make it show the next 3 upcoming events and link to the full page for everything else.", timestamp: '2026-03-03T13:00:33Z' },
  {
    id: 'ce-4', taskId: 'cafe-events', role: 'agent', agentId: 'wpcom',
  ...
  { id: 'ce-5', taskId: 'cafe-events', role: 'user', content: "Love it. Can people RSVP to events?", timestamp: '2026-03-03T13:03:24Z' },
  { id: 'ce-6', taskId: 'cafe-events', role: 'agent', agentId: 'wpcom', content: "Not yet, but since you already have Simply Schedule Appointments, I can add an RSVP form — name, email, party size — with confirmation emails. Want me to set that up?", timestamp: '2026-03-03T13:03:31Z' },
  { id: 'ce-7', taskId: 'cafe-events', role: 'user', content: "That would be great, yeah.", timestamp: '2026-03-03T13:03:48Z' },
  {
    id: 'ce-8', taskId: 'cafe-events', role: 'agent', agentId: 'wpcom',
    content: "",
    toolCalls: [
...
\t</style>';
  ...
  // ═══════════════════════════════════════════
  { id: 'po-1', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "Hey! Kit here, ready when you are.", timestamp: '2026-01-20T09:00:00Z' },
  { id: 'po-2', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "I can design and build just about anything — stores, blogs, portfolios, apps. Describe what you want and I'll make it happen.", timestamp: '2026-01-20T09:00:10Z' },
  { id: 'po-3', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "So, what are we making?", timestamp: '2026-01-20T09:00:15Z' },
  { id: 'po-4', taskId: 'portfolio-onboarding', role: 'user', content: "Portfolio", timestamp: '2026-01-20T09:00:30Z' },
  { id: 'po-5', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "Love it. What's your name, or what should we call the site?", timestamp: '2026-01-20T09:00:35Z' },
  { id: 'po-6', taskId: 'portfolio-onboarding', role: 'user', content: "Studio Meridian", timestamp: '2026-01-20T09:01:00Z' },
  { id: 'po-7', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "In a sentence — what kind of work do you do?", timestamp: '2026-01-20T09:01:05Z' },
  { id: 'po-8', taskId: 'portfolio-onboarding', role: 'user', content: "A design studio crafting digital experiences with precision, clarity, and human connection", timestamp: '2026-01-20T09:01:30Z' },
  { id: 'po-9', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "How do you want the site to look and feel?", timestamp: '2026-01-20T09:01:35Z' },
  { id: 'po-10', taskId: 'portfolio-onboarding', role: 'user', content: "Swiss minimal — clean lines, lots of whitespace, precise typography. Think Dieter Rams meets the web.", timestamp: '2026-01-20T09:02:10Z' },
  { id: 'po-11', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "Any sites you really like for inspiration?", timestamp: '2026-01-20T09:02:15Z' },
  { id: 'po-12', taskId: 'portfolio-onboarding', role: 'user', content: "linear.app, stripe.com, apple.com", timestamp: '2026-01-20T09:02:40Z' },
  { id: 'po-13', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "Let me design **Studio Meridian** for you. I'll create a few directions to choose from.", timestamp: '2026-01-20T09:02:45Z' },
  { id: 'po-14', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "Crafting design briefs…", timestamp: '2026-01-20T09:02:50Z' },
  { id: 'po-15', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "Here are 3 directions for **Studio Meridian**. Pick the one that feels right:", timestamp: '2026-01-20T09:03:30Z' },
  { id: 'po-16', taskId: 'portfolio-onboarding', role: 'user', content: "Swiss Precision", timestamp: '2026-01-20T09:04:00Z' },
  { id: 'po-17', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "**Swiss Precision** — minimal, grid-driven layout with generous whitespace. Typography-led hierarchy using Inter. Monochrome palette with electric blue accent. Building it now.", timestamp: '2026-01-20T09:04:05Z' },
  {
    id: 'po-18', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom',
    content: "",
    toolCalls: [
  ...
  { id: 'po-19', taskId: 'portfolio-onboarding', role: 'agent', agentId: 'wpcom', content: "**Studio Meridian** is ready! 3 pages, 10 sections. Take a look.", timestamp: '2026-01-20T09:06:00Z' },

  // ═══════════════════════════════════════════
  // Studio Meridian — case study
  // ═══════════════════════════════════════════
  { id: 'pa1-1', taskId: 'portfolio-assistant-1', role: 'user', content: "I want to add a case study for a recent project — a brand identity we did for Oura.", timestamp: '2026-02-15T14:00:00Z' },
  { id: 'pa1-2', taskId: 'portfolio-assistant-1', role: 'agent', agentId: 'wpcom', content: "Great project to showcase. Full breakdown with brief, process, and outcome — or just the highlights?", timestamp: '2026-02-15T14:00:30Z' },
  { id: 'pa1-3', taskId: 'portfolio-assistant-1', role: 'user', content: "Full breakdown. Hero image with the ring on a dark background, then sections for the brief, our process, and the final deliverables. Keep the Swiss minimal feel.", timestamp: '2026-02-15T14:01:15Z' },
  {
    id: 'pa1-4', taskId: 'portfolio-assistant-1', role: 'agent', agentId: 'wpcom',
  ...
  { id: 'pa1-5', taskId: 'portfolio-assistant-1', role: 'user', content: "Looks great. Can you add a \"Next project\" link at the bottom that goes to the Stripe case study?", timestamp: '2026-02-15T14:03:00Z' },
  {
    id: 'pa1-6', taskId: 'portfolio-assistant-1', role: 'agent', agentId: 'wpcom',
  ...
  // ═══════════════════════════════════════════
  { id: 'rd1-1', taskId: 'records-design-1', role: 'user', content: 'I want a full-bleed photo gallery as the homepage. Moody, editorial — the photos should do the talking. Minimal UI.', timestamp: '2026-02-05T13:00:00Z' },
  { id: 'rd1-2', taskId: 'records-design-1', role: 'agent', agentId: 'wpcom', content: "Love it. I'm thinking a masonry grid that fills the viewport — no gutters, photos edge-to-edge. Click to open a lightbox with EXIF data and caption. Dark chrome so the images pop. Let me draft the layout.", timestamp: '2026-02-05T13:01:00Z' },
  { id: 'rd1-3', taskId: 'records-design-1', role: 'agent', agentId: 'wpcom', content: "Here's the direction:\n\n**Layout**\n- Full-bleed masonry grid, no gutters\n- Hover: subtle zoom + title overlay\n- Lightbox with EXIF, caption, and prev/next\n\n**Palette**\n- Background: #0A0A0A\n- Text: #F5F0EB\n- Accent: #E8E0D6\n\nThe homepage is all photos. About page and contact are minimal — just text on dark. Check the preview — want to tweak anything?", timestamp: '2026-02-05T13:02:00Z' },

  // ═══════════════════════════════════════════
  // Thread & Co — product card layout
  // ═══════════════════════════════════════════
  { id: 'ma1-1', taskId: 'mise-assistant-1', role: 'user', content: 'The product cards need a better layout. I want to show price and available sizes more prominently.', timestamp: '2026-02-08T11:30:00Z' },
  {
    id: 'ma1-2', taskId: 'mise-assistant-1', role: 'agent', agentId: 'wpcom',
  ...
  // ═══════════════════════════════════════════
  { id: 'la1-1', taskId: 'ledger-assistant-1', role: 'user', content: 'I need a landing page template. Hero with headline + CTA, features grid, testimonials, and a pricing section.', timestamp: '2026-02-10T09:30:00Z' },
  {
    id: 'la1-2', taskId: 'ledger-assistant-1', role: 'agent', agentId: 'wpcom',
  ...
  // ═══════════════════════════════════════════
  { id: 'lc1-1', taskId: 'ledger-code-1', role: 'user', content: 'I need a REST endpoint for the signup flow — accepts email, creates an account, and returns an auth token.', timestamp: '2026-02-11T10:00:00Z' },
  {
    id: 'lc1-2', taskId: 'ledger-code-1', role: 'agent', agentId: 'wpcom',
  ...
  // ═══════════════════════════════════════════
  { id: 'fc1-1', taskId: 'fuego-assistant-1', role: 'user', content: 'I need a docs site — API reference, guides section, and a search that actually works. Maybe 20-30 pages to start.', timestamp: '2026-02-14T12:30:00Z' },
  { id: 'fc1-2', taskId: 'fuego-assistant-1', role: 'agent', agentId: 'wpcom', content: "I'll set up a docs structure with sidebar navigation, versioned API reference, and full-text search. Let me get the foundation in.", timestamp: '2026-02-14T12:30:30Z' },
  {
    id: 'fc1-3', taskId: 'fuego-assistant-1', role: 'agent', agentId: 'wpcom',
  ...
  { id: 'fc1-4', taskId: 'fuego-assistant-1', role: 'user', content: "I'll add the Algolia key later. Start with the API Reference section — I need endpoints for Users, Projects, and Webhooks. Each endpoint should show method, URL, params, and example response.", timestamp: '2026-02-14T12:32:30Z' },
  {
    id: 'fc1-5', taskId: 'fuego-assistant-1', role: 'agent', agentId: 'wpcom',
  ...
  { id: 'fc1-6', taskId: 'fuego-assistant-1', role: 'user', content: "Can we add a changelog page too? I want to log API changes by version.", timestamp: '2026-02-14T12:34:30Z' },
  {
    id: 'fc1-7', taskId: 'fuego-assistant-1', role: 'agent', agentId: 'wpcom',
